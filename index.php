...
<html lang="fr">
    ...
    <!------------ ARROW DOWN Menu------------>
        <div class="wrapper" id="arrowAcceuil">
            <a class="cta" href="#down">
                <span>
                    <span>Menu</span>
                    <svg class="downArrow" width="66px" height="43px" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    <!------------ TEXTE ------------>
            <div data-aos="fade-right" data-aos-delay="500" data-aos-duration="1000">
                <figure class="text-center texteHome" id="down">
                    <blockquote class="blockquote">
                        <p> ALLONS-Y, ALONSO !</p>
                    </blockquote>
                    <figcaption class="blockquote-footer">
                        <cite title="Source Title">Doctor Who,</cite> le dixiéme docteur.
                    </figcaption>
                </figure>
            </div>
