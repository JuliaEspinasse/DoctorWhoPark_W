...
<html lang="fr">
    ...
    <section>
        <!------------ TEXTE ------------>
        <figure class="text-center texteLeft">
            <blockquote class="blockquote">
                <p>On m’appelle Le Doctor, ou le gardien, ou « dégagez de cette planète ! » </p>
            </blockquote>
        ...
        <div class="wrapper" id="arrow">
            ...
            <a class="cta" href="lesEvenements.php" id="nextArrow">
        ...
        <!-- ---------- Card ---------- -->
        <div class="row row-cols-1 row-cols-md-3 g-4 rowRight">
            <div class="col">
                <a href="#">
                    <div class="card">
